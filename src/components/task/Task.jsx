    ...
    render(){
        return (
            <div className="task-container">
                <input type="checkbox" className="form-check-input do-undo" onClick={()=>this.handleToggle(this.props.taskObject.id)}></input>
                ...
                <button type="button" className="btn btn-danger btn-lg btn-delete" onClick={()=>this.handleDelete(this.props.taskObject.id)}>Delete</button>
            </div>
        )
    }
}

const Task = ConnectedTask
